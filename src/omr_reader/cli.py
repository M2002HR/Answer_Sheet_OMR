...
def _build_runtime_config(
    ...
    *,
    ...
    allow_multiple_marks: bool | None,
    ...
    return apply_overrides(
        base,
        {
            "classification": {
                ...
                "allow_multiple_marks": allow_multiple_marks,
            },
            "scoring": {
...
def analyze_command(
    ...
    allow_multiple_marks: bool | None = typer.Option(
        None,
        "--allow-multiple-marks/--single-mark-only",
        help="Keep multi-mark questions as multiple instead of collapsing them to the top-scoring option.",
    ),
